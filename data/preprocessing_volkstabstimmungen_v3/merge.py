...
pivot_table = voting_results.pivot_table(index='gemeinde_geoId', columns='vorlage_id', values='gemeinde_yesPercentage', aggfunc='first')
...
# create as json file
dic = {
    "datasetName": "NEW Voting Data From Switzerland",
